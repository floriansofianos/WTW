var movieSearchController = function (movieDBService, movieQuestionnaireService, movieCacheService, userProfileService, movieRecommandationService, userService) {
    ...
    var wtw = function (req, res) {
        if (req.user && req.query.lang) {
            movieDBService.wtw(req.user.id, req.user.country, req.query.lang, req.query.genreId, req.query.useWatchlist == "true", req.query.nowPlaying == "true", req.query.useRuntimeLimit == "true", req.query.runtimeLimit, req.query.minRelease, req.query.maxRelease, movieDBService.getRatingCertification(req.user.yearOfBirth), req.query.languageSelected, req.query.friendId, movieQuestionnaireService, movieCacheService, userProfileService, movieRecommandationService, movieDBService, function (err, result) {
