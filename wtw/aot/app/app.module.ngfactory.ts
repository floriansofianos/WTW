...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __BrowserXhr_31:import20.BrowserXhr;
  __ResponseOptions_32:import21.BaseResponseOptions;
  __XSRFStrategy_33:any;
  __XHRBackend_34:import22.XHRBackend;
  __RequestOptions_35:import23.BaseRequestOptions;
  __Http_36:any;
  __TranslateLoader_37:any;
  __TranslateParser_38:import24.TranslateDefaultParser;
  __MissingTranslationHandler_39:import25.FakeMissingTranslationHandler;
  __TranslateStore_40:import26.TranslateStore;
  __USE_STORE_41:any;
  __TranslateService_42:import27.TranslateService;
  constructor(parent:import28.Injector) {
    super(parent,[import29.MainAppComponentNgFactory],[import29.MainAppComponentNgFactory]);
  }
  get _LOCALE_ID_6():any {
    if ((this.__LOCALE_ID_6 == null)) { (this.__LOCALE_ID_6 = import3._localeFactory(this.parent.get(import30.LOCALE_ID,(null as any)))); }
  ...
  get _APP_ID_14():any {
    if ((this.__APP_ID_14 == null)) { (this.__APP_ID_14 = import31._appIdRandomProviderFactory()); }
  ...
  get _EventManager_18():import13.EventManager {
    if ((this.__EventManager_18 == null)) { (this.__EventManager_18 = new import13.EventManager(this._EVENT_MANAGER_PLUGINS_17,this.parent.get(import34.NgZone))); }
  ...
  get _RootRenderer_22():any {
    if ((this.__RootRenderer_22 == null)) { (this.__RootRenderer_22 = import35._createConditionalRootRenderer(this._DomRootRenderer_21,this.parent.get(import35.NgProbeToken,(null as any)),this.parent.get(import10.NgProbeToken,(null as any)))); }
  ...
  get _AnimationQueue_25():import17.AnimationQueue {
    if ((this.__AnimationQueue_25 == null)) { (this.__AnimationQueue_25 = new import17.AnimationQueue(this.parent.get(import34.NgZone))); }
  ...
  get _BrowserXhr_31():import20.BrowserXhr {
    if ((this.__BrowserXhr_31 == null)) { (this.__BrowserXhr_31 = new import20.BrowserXhr()); }
    return this.__BrowserXhr_31;
  }
  get _ResponseOptions_32():import21.BaseResponseOptions {
    if ((this.__ResponseOptions_32 == null)) { (this.__ResponseOptions_32 = new import21.BaseResponseOptions()); }
  ...
  get _XHRBackend_34():import22.XHRBackend {
    if ((this.__XHRBackend_34 == null)) { (this.__XHRBackend_34 = new import22.XHRBackend(this._BrowserXhr_31,this._ResponseOptions_32,this._XSRFStrategy_33)); }
    return this.__XHRBackend_34;
  }
  get _RequestOptions_35():import23.BaseRequestOptions {
    if ((this.__RequestOptions_35 == null)) { (this.__RequestOptions_35 = new import23.BaseRequestOptions()); }
  ...
  get _TranslateLoader_37():any {
    if ((this.__TranslateLoader_37 == null)) { (this.__TranslateLoader_37 = import1.createTranslateLoader(this._Http_36)); }
    return this.__TranslateLoader_37;
  }
  get _TranslateParser_38():import24.TranslateDefaultParser {
    if ((this.__TranslateParser_38 == null)) { (this.__TranslateParser_38 = new import24.TranslateDefaultParser()); }
    return this.__TranslateParser_38;
  }
  get _MissingTranslationHandler_39():import25.FakeMissingTranslationHandler {
    if ((this.__MissingTranslationHandler_39 == null)) { (this.__MissingTranslationHandler_39 = new import25.FakeMissingTranslationHandler()); }
    return this.__MissingTranslationHandler_39;
  }
  get _TranslateStore_40():import26.TranslateStore {
    if ((this.__TranslateStore_40 == null)) { (this.__TranslateStore_40 = new import26.TranslateStore()); }
  ...
  get _TranslateService_42():import27.TranslateService {
    if ((this.__TranslateService_42 == null)) { (this.__TranslateService_42 = new import27.TranslateService(this._TranslateStore_40,this._TranslateLoader_37,this._TranslateParser_38,this._MissingTranslationHandler_39,this._USE_STORE_41)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ApplicationRef__11 = new import10.ApplicationRef_(this.parent.get(import34.NgZone),this.parent.get(import36.Console),this,this._ErrorHandler_8,this,this._ApplicationInitStatus_9,this.parent.get(import9.TestabilityRegistry,(null as any)),this._Testability_10);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import30.LOCALE_ID)) { return this._LOCALE_ID_6; }
    if ((token === import7.NgLocalization)) { return this._NgLocalization_7; }
    if ((token === import37.ErrorHandler)) { return this._ErrorHandler_8; }
    ...
    if ((token === import31.APP_ID)) { return this._APP_ID_14; }
    if ((token === import38.DOCUMENT)) { return this._DOCUMENT_15; }
    ...
    if ((token === import39.AnimationDriver)) { return this._AnimationDriver_20; }
    if ((token === import15.DomRootRenderer)) { return this._DomRootRenderer_21; }
    if ((token === import40.RootRenderer)) { return this._RootRenderer_22; }
    if ((token === import16.DomSanitizer)) { return this._DomSanitizer_23; }
    if ((token === import41.Sanitizer)) { return this._Sanitizer_24; }
    ...
    if ((token === import20.BrowserXhr)) { return this._BrowserXhr_31; }
    if ((token === import21.ResponseOptions)) { return this._ResponseOptions_32; }
    if ((token === import44.XSRFStrategy)) { return this._XSRFStrategy_33; }
    if ((token === import22.XHRBackend)) { return this._XHRBackend_34; }
    if ((token === import23.RequestOptions)) { return this._RequestOptions_35; }
    if ((token === import45.Http)) { return this._Http_36; }
    if ((token === import46.TranslateLoader)) { return this._TranslateLoader_37; }
    if ((token === import24.TranslateParser)) { return this._TranslateParser_38; }
    if ((token === import25.MissingTranslationHandler)) { return this._MissingTranslationHandler_39; }
    if ((token === import26.TranslateStore)) { return this._TranslateStore_40; }
    if ((token === import27.USE_STORE)) { return this._USE_STORE_41; }
    if ((token === import27.TranslateService)) { return this._TranslateService_42; }
