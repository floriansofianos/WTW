...
var AppModuleInjector = (function (_super) {
    ...
    function AppModuleInjector(parent) {
        ...
        ], [import37.MainAppComponentNgFactory]) || this;
    }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NgProbeToken_24", {
        get: function () {
            if ((this.__NgProbeToken_24 == null)) {
                (this.__NgProbeToken_24 = [import5.routerNgProbeToken()]);
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_41", {
        get: function () {
            if ((this.__LocationStrategy_41 == null)) {
                (this.__LocationStrategy_41 = import5.provideLocationStrategy(this.parent.get(import44.PlatformLocation), this.parent.get(import45.APP_BASE_HREF, null), this._ROUTER_CONFIGURATION_40));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Router_47", {
        get: function () {
            if ((this.__Router_47 == null)) {
                (this.__Router_47 = import5.setupRouter(this._ApplicationRef_14, this._UrlSerializer_43, this._RouterOutletMap_44, this._Location_42, this, this._NgModuleFactoryLoader_45, this._Compiler_15, this._ROUTES_46, this._ROUTER_CONFIGURATION_40, this.parent.get(import48.UrlHandlingStrategy, null), this.parent.get(import49.RouteReuseStrategy, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ROUTER_INITIALIZER_53", {
        get: function () {
            if ((this.__ROUTER_INITIALIZER_53 == null)) {
                (this.__ROUTER_INITIALIZER_53 = import5.initialRouterNavigation(this._Router_47, this._ApplicationRef_14, this._RouterPreloader_51, this._ROUTER_CONFIGURATION_40));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_TranslateLoader_55", {
        get: function () {
            if ((this.__TranslateLoader_55 == null)) {
                (this.__TranslateLoader_55 = import1.createTranslateLoader(this._Http_39));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_TranslateParser_56", {
        get: function () {
            if ((this.__TranslateParser_56 == null)) {
                (this.__TranslateParser_56 = new import30.TranslateDefaultParser());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_MissingTranslationHandler_57", {
        get: function () {
            if ((this.__MissingTranslationHandler_57 == null)) {
                (this.__MissingTranslationHandler_57 = new import31.FakeMissingTranslationHandler());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_TranslateStore_58", {
        get: function () {
            if ((this.__TranslateStore_58 == null)) {
                (this.__TranslateStore_58 = new import32.TranslateStore());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_USE_STORE_59", {
        get: function () {
            if ((this.__USE_STORE_59 == null)) {
                (this.__USE_STORE_59 = undefined);
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_TranslateService_60", {
        get: function () {
            if ((this.__TranslateService_60 == null)) {
                (this.__TranslateService_60 = new import33.TranslateService(this._TranslateStore_58, this._TranslateLoader_55, this._TranslateParser_56, this._MissingTranslationHandler_57, this._USE_STORE_59));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ROUTER_FORROOT_GUARD_3 = import5.provideForRootGuard(this.parent.get(import50.Router, null));
        ...
        this._ApplicationRef__13 = new import11.ApplicationRef_(this.parent.get(import42.NgZone), this.parent.get(import51.Console), this, this._ErrorHandler_10, this, this._ApplicationInitStatus_11, this.parent.get(import10.TestabilityRegistry, null), this._Testability_12);
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import7.TranslateModule)) {
            return this._TranslateModule_6;
        }
        ...
        if ((token === import64.TranslateLoader)) {
            return this._TranslateLoader_55;
        }
        if ((token === import30.TranslateParser)) {
            return this._TranslateParser_56;
        }
        if ((token === import31.MissingTranslationHandler)) {
            return this._MissingTranslationHandler_57;
        }
        if ((token === import32.TranslateStore)) {
            return this._TranslateStore_58;
        }
        if ((token === import33.USE_STORE)) {
            return this._USE_STORE_59;
        }
        if ((token === import33.TranslateService)) {
            return this._TranslateService_60;
        }
